...
export const Chat = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-blue-50 to-cyan-50">
      ...
      {/* Enhanced Message Input - Larger and Better */}
      <div className="bg-white border-t-2 border-emerald-200 p-6 shadow-lg sticky bottom-0">
        <div className="flex gap-4 items-end max-w-5xl mx-auto">
          <div className="flex-1">
            <textarea
              ...
              placeholder="اكتب رسالتك أو الصق المحتوى الطويل هنا..."
              className="w-full min-h-16 max-h-48 text-right border-2 border-emerald-200 focus:ring-2 focus:ring-emerald-400 focus:border-emerald-400 rounded-xl px-6 py-4 shadow-sm resize-none overflow-y-auto text-base bg-white"
              style={{ 
                direction: 'rtl', 
          ...
          <Button 
            ...
            className="h-16 w-16 bg-emerald-500 hover:bg-emerald-600 text-white shadow-lg transition-all duration-200 rounded-xl"
          >
